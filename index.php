...
<body>
    ...
    <div class="container-fluid banner">
      <div class="container banner-content col-lg-8 col-sm-1">
        ...
        <div class="col-12">
          <div class="col-lg-12">
            ...
            <?php while ($row = mysqli_fetch_assoc($feedback)) : ?>
              <div class="col-lg-3 col-md-4 col-sm-6 mb-5">
                <div class="card">
                  <div class="card-header">Date : <?php echo $row['tanggal_submit']; ?></div>

                  <div class="card-body">
                    <blockquote class="blockquote mb-3">
                      <p><?php echo $row['deskripsi']; ?></p>
                      <footer class="blockquote-footer"><cite title="Source Title"></cite><?php echo $row['nama']; ?></footer>
                    </blockquote>
                    <p>Rate : <?php echo $row['rating'] . '/5'; ?></p>
                  </div>
                </div>
              </div>
              <?php endwhile; ?>
